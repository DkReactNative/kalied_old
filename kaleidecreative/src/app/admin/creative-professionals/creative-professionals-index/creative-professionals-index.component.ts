...
@Component({
  selector: 'app-creative-professionals-index',
  templateUrl: './creative-professionals-index.component.html',
  styleUrls: ['./creative-professionals-index.component.css']
})
export class CreativeProfessionalsIndexComponent implements OnInit {
  user;
  globalSettings;
  globals = environment;

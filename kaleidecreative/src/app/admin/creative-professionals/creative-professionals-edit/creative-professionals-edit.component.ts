...
@Component({
  selector: 'app-creative-professionals-edit',
  templateUrl: './creative-professionals-edit.component.html',
  styleUrls: ['./creative-professionals-edit.component.css']
})
export class CreativeProfessionalsEditComponent implements OnInit {
  user;
  globalSettings;
  globals = environment;

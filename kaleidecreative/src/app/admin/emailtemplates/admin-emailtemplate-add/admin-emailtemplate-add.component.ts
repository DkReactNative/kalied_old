...
@Component({
  selector: 'app-admin-emailtemplate-add',
  templateUrl: './admin-emailtemplate-add.component.html',
  styleUrls: ['./admin-emailtemplate-add.component.css']
})
export class AdminEmailtemplateAddComponent implements OnInit {
  user;
  globalSettings;
  globals = environment;
  ...
  newRecordSubmit =  (formData) => {
    ...
    newFormData.append("subject", formData.subject.trim())
    newFormData.append("content", formData.content)
    this.ngxService.start();
    this.myservices.post("admin/"+this.pageSlug +"/create", newFormData,response=>{

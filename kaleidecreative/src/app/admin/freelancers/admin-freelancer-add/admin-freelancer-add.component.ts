...
@Component({
  selector: 'app-admin-freelancer-add',
  templateUrl: './admin-freelancer-add.component.html',
  styleUrls: ['./admin-freelancer-add.component.css']
})

export class AdminFreelancerAddComponent implements OnInit {
  user;
  globalSettings;
  globals = environment;

  pageTitle = "Freelancer"
  pageSlug = "admin/freelancer"
  user_id;
  imageUrl;
  ...
  newRecordSubmit = async (formData) => {
    if (formData.password == formData.confirm_password) {
      ...
      newFormData.append("freelancer_type",formData.freelancer_type)    

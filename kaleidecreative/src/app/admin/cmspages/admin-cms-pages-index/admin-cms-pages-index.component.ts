...
@Component({
  selector: 'app-admin-cms-pages-index',
  templateUrl: './admin-cms-pages-index.component.html',
  styleUrls: ['./admin-cms-pages-index.component.css']
})
export class AdminCmsPagesIndexComponent implements OnInit {
  user;
  globalSettings;
  globals = environment;
  ...
  getRecords = async (page) => {
    ...
    newFormData.append("searchForm", (this.searchData.title));
    await this.myservices.post(this.pageSlug, newFormData, response => {      

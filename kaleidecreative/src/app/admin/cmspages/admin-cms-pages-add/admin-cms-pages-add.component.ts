...
@Component({
  selector: "app-admin-cms-pages-add",
  templateUrl: "./admin-cms-pages-add.component.html",
  styleUrls: ["./admin-cms-pages-add.component.css"],
})
export class AdminCmsPagesAddComponent implements OnInit {
  public config = {
  ...
  newRecordSubmit = async (formData) => {
    ...
    await this.myservices.post(
      this.pageSlug + "/create",
      newFormData,
      (response) => {

...
@Component({
  selector: 'app-top-client-add',
  templateUrl: './top-client-add.component.html',
  styleUrls: ['./top-client-add.component.css']
})
export class TopClientAddComponent implements OnInit {
user;
  globalSettings;
  globals = environment;

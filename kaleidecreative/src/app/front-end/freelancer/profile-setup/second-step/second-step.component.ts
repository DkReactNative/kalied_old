...
export class SecondStepComponent implements OnInit {
  ...
  primarySkill: any = [
    { name: "Pear", value: "1" },
    { name: "Adobe Premiere", value: "2" },
    { name: "Avid", value: "3" },
    { name: "Final Cut", value: "4" },
    { name: "Typography", value: "5" },
  ];

  secondarySkill: any = [
    { name: "Time management", value: "1" },
    { name: "Motion graphics", value: "2" },
    { name: "Story producer", value: "3" },
    { name: "Audio mixing", value: "4" },
    { name: "Color correction", value: "5" },
    { name: "Communication", value: "6" },
  ];

  editingStyle: any = [
    { name: "Structural editing", value: "1" },
    { name: "Copy editing", value: "2" },
    { name: "Line editing", value: "3" },
    { name: "Proofreading", value: "4" },
    { name: "Fact-checking", value: "5" },
    { name: "Indexing", value: "6" },
  ];

  graphicSpecialties: any = [
    { name: "Logo Design", value: "1" },
    { name: "Packaging Design", value: "2" },
    { name: "Iconography", value: "3" },
    { name: "Web and Mobile Design", value: "4" },
    { name: "Layout and Print Design", value: "5" },
    { name: "User Interface Animation", value: "6" },
    { name: "Print Media", value: "7" },
    { name: "Motion graphic design", value: "8" },
  ];

  awards: any = [
    { name: "Best Branding Design", value: "1" },
    { name: "Best Packaging Design", value: "2" },
    { name: "Best Print Design", value: "3" },
    { name: "Best use of Typography", value: "4" },
    { name: "Best Digital Design", value: "5" },
    { name: "Best Branding Design", value: "6" },
    { name: "Best Packaging Design", value: "7" },
    { name: "Best Print Design", value: "8" },
    { name: "Best use of Typography", value: "9" },
    { name: "Best Digital Design", value: "10" },
  ];
  constructor(

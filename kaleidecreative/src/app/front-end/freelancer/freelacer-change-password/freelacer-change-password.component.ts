...
@Component({
  selector: "app-freelacer-change-password",
  templateUrl: "./freelacer-change-password.component.html",
  styleUrls: ["./freelacer-change-password.component.css"],
})
export class FreelacerChangePasswordComponent implements OnInit {
  formData;
  ...
  callRegisterApi(formdata) {
    ...
    newFormData.append("old_password", formdata.oldpassword);

...
@Component({
  selector: "app-freelacer-mydetails",
  templateUrl: "./freelacer-mydetails.component.html",
  styleUrls: ["./freelacer-mydetails.component.css"],
})
export class FreelacerMydetailsComponent implements OnInit {
    ...
    this.global.get(
      ...
      (data) => {
        ...
        if (data.status) {
          ...
          this.formData
            .get("freelancerType")
            .setValue(user.freelancer_type ? user.freelancer_type : "");
  ...
  onClickSubmit(formdata) {
    ...
    newFormData.append("freelancer_type", formdata.freelancerType);
    if (this.image) {

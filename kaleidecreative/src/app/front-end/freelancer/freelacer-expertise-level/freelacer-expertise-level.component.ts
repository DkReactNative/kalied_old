...
@Component({
  selector: "app-freelacer-expertise-level",
  templateUrl: "./freelacer-expertise-level.component.html",
  styleUrls: ["./freelacer-expertise-level.component.css"],
})
export class FreelacerExpertiseLevelComponent implements OnInit {
  ...
  createClient(data = null): FormGroup {
    ...
    let workLength = data && data.work_length ? data.work_length : "";
    ...
    return this.formBuilder.group({
      ...
      workLength: new FormControl(
        workLength,
        CustomValidators.rangeLength([1, 30])
      ),
